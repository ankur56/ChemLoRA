...
def get_data(prop_to_get):
    ...
    prop = {"b3lyp": "B3LYP atomization energy in kcal/mol",
            "g4mp2": "atomization energy in kcal/mol",
...
if __name__ == "__main__":
    ...
    train(df_train, df_val, base_model="gpt2", prop="g4mp2")
    outs=generate(df_test.head(1000), base_model="gpt2", prop="g4mp2")
    outs.to_json(f"outputs_gpt2_g4mp2_500_e20.json")
