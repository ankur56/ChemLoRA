...
def get_data(prop_to_get):
    ...
    prop = {"b3lyp": "atomization energy in kcal/mol",
...
if __name__ == "__main__":
    ...
    train(df_train, df_val, base_model="gpt2", prop="b3lyp")
    outs=generate(df_test.head(1000), base_model="gpt2", prop="b3lyp")
    outs.to_json(f"outputs_gpt2_b3lyp_1000_e20.json")
